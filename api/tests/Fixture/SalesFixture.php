...
class SalesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'customer_id' => ['type' => 'string', 'length' => 45, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'modified' => '2017-05-30 16:11:40',
            'created' => '2017-05-30 16:11:40'
        ],
    ];
}
