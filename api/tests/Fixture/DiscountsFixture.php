...
class DiscountsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'product_all' => ['type' => 'integer', 'length' => 4, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'discount' => ['type' => 'string', 'length' => 45, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'end_date' => '2017-05-30',
            'modified' => '2017-05-30 16:11:24',
            'created' => '2017-05-30 16:11:24'
        ],
    ];
}
